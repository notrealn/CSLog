...
INSERT INTO "new_Transaction" ("amountCheckedOut", "amountLost", "amountRemaining", "amountUsed", "comment", "containerId", "date", "description", "fromId", "id", "newGross", "purpose", "toId", "userId", "verifierId") SELECT "amountCheckedOut", "amountLost", "amountRemaining", "amountUsed", "comment", "containerId", "date", "description", "fromId", "id", "newGross", "purpose", "toId", "userId", "verifierId" FROM "Transaction";
